 ...
 */
export declare function isBrandManufacturerLinkAllowed(brandId: string, manufacturerId: string | null | undefined, manufacturer: BrandManufacturerGateData | null | undefined, options: BrandManufacturerGateOptions): boolean;
//# sourceMappingURL=derivationGate.d.ts.map